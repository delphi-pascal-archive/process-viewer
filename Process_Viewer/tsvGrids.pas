...
//  TtsvInplaceEdit = class(TCustomEdit)
  private
...
//  FFilterItems.Add('ObjectMenuItem');
  ...
  FFilterItems.Add('Tag');
  FFilterItems.Add('VertScrollBar');
  FFilterItems.Add('Visible');
  FFilterItems.Add('WindowMenu');
  FFilterItems.Add('WindowState');
  FFilterItems.Add('ObjId');
  *)}
end;
...
{  ListLang.Clear;
  ...
  with ListLang do begin
    ...
    Add('BorderStyle');
    ListRus.Add('Стиль заголовка');
    Add('BorderWidth');
    ListRus.Add('Ширина заголовка');
    Add('Caption');
    ...
    Add('IntegralHeight');
    ListRus.Add('Интегральна высота');
    Add('MultiSelect');
    ...
    // TPanel
    Add('BevelInner');
    ListRus.Add('Граница внутреняя');
    Add('BevelOuter');
    ListRus.Add('Граница внешняя');
    Add('BevelWidth');
    ListRus.Add('Граница ширина');
    Add('FullRepaint');
    ...
    ListRus.Add('Выбор');
    Add('MaxDate');
    ListRus.Add('Макс. дата');
    Add('MinDate');
    ListRus.Add('Мин. дата');
    Add('ParseInput');
...
{    Add('Color');
    ...
    ListRus.Add('Заголовок');
    Add('Alignment');
    ListRus.Add('Центровка по горизонтали');
    Add('AutoSize');
    ListRus.Add('Авторазмер');
    Add('Layout');
    ListRus.Add('Цетровка по вертикали');
    Add('OnClickState');
    ListRus.Add('Состояние при нажатии мышкой');
    Add('Active');
    ListRus.Add('Активность');
    Add('BorderColor');
    ListRus.Add('Цвет бодюра');
    Add('BorderWidth');
    ListRus.Add('Ширина бодюра');
    Add('TextStyle');
    ListRus.Add('Стиль текста');
    Add('ShadowColor');
    ListRus.Add('Цвет тени');
    Add('ShadowWidth');
    ListRus.Add('Ширина тени');
    Add('OnExtendedState');
    ListRus.Add('Состояние расширенное');
    Add('OnMouseEnterState');
    ListRus.Add('Состояние при наведении мышкой');
    Add('WordWrap');
    ListRus.Add('Перенос слов');}
//  end;
end;
